...
| `JOURNEY_SEARCH_STRATEGY` | `two_leg_indexed` | Search algorithm to use (`two_leg_indexed`) |
...
The contract for this API is defined in the [OpenAPI spec](https://gitlab.com/kiusys/challenge/-/blob/main/events-api/openapi.yaml) provided with the challenge.
